...
See [configuration Instructions](react-native-hms-map/configuration.md).
...
After [configuration](react-native-hms-map/configuration.md), install the library from npm:
